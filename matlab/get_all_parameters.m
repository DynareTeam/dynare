...
% 
% INPUTS
%	 estim_params:  Dynare structure describing the estimated parameters.
%    M:             Dynare structure describing the model. 
%
% OUTPUTS
...
Sigma_e = M_.Sigma_e;
H = M_.H;
xparam1=zeros(nvx+ncx+nvn+ncn+np,1);
...
if ncx
    ...
    for i=1:ncx
        k1 = corrx(i,1);
        k2 = corrx(i,2);
        xparam1(i+offset)=Sigma_e(k1,k2)/sqrt(Sigma_e(k1,k1)*Sigma_e(k2,k2));
    end
end
% update offset
offset = nvx+nvn+ncx;
