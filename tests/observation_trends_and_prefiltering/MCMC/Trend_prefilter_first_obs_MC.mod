...
if abs(mean(oo_.SmoothedShocks.Mean.e_y))>5e-4 || abs(mean(oo_.SmoothedShocks.Mean.e_p))>5e-4 || abs(mean(oo_.SmoothedShocks.Median.e_y))>5e-4 || abs(mean(oo_.SmoothedShocks.Median.e_p))>5e-4
